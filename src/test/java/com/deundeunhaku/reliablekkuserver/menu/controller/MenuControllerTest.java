...
class MenuControllerTest extends BaseControllerTest {
  ...
  void 메뉴의_리스트를_반환한다() throws Exception {
      //given
    MenuResponse menuResponse1 = MenuResponse.of(1L,"imageUrl1", "든붕이", 1000, 3000);
    MenuResponse menuResponse2 = MenuResponse.of(2L,"imageUrl2", "팥붕이", 2000, 5000);
    MenuResponse menuResponse3 = MenuResponse.of(3L, "imageUrl3", "누붕이", 3000, 7000);
