  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
    ...
    http
        ...
        auth
            ...
            .requestMatchers(mvcMatcherBuilder.pattern("/api/v1/auth/login")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern("/api/v1/find-password")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern("/api/v1/find-password/phone-number/certification-number")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern("/api/v1/register")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern("/api/v1/register/phone-number/duplicate")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern("/api/v1/register/phone-number/certification-number")).permitAll()
